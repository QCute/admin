...
// GameTok Mini Game login
Route::get("/GameTokLogin", [MiniGameController::class, "gameTokLogin"]);

// GameTok Mini Game Product List
Route::get("/GameTokProductList", [MiniGameController::class, "gameTokProductList"]);

// GameTok Mini Game Purchase
Route::get("/GameTokPurchase", [MiniGameController::class, "gameTokPurchase"]);
