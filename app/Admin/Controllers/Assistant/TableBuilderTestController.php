...
class TableBuilderTestController extends Controller
{
    ...
    {
        $header = collect([
            (new Header())->field('os')->title(trans('admin.os'))->align(),
            (new Header())->field('platform')->title(trans('admin.platform'))->align(),
            (new Header())->field('channel')->title(trans('admin.channel'))->align(),
            (new Header())->field('number')->title(trans('admin.number'))->align(),
        ]);
