...
use App\Admin\Models\OperationModels\GameMailModel;
...
class GameMailController extends AdminController
{
    ...
    {
        $form = new Form(new GameMailModel());
        $form->setTitle(trans("admin.mail"));
        $options = [
        ...
        $form->textarea("roleId", trans("admin.role_id"))->style("resize", "vertical");
