...
return [
    ...
    */
    'server' => [
        ...
        'port' => !empty(env("APP_PORT")) ? (int) env("APP_PORT") : ((bool) env("APP_HTTPS", true) ? 443 : 80),
        ...
        'socket_type' => SWOOLE_SOCK_TCP | ((bool) env("APP_HTTPS", true) ? SWOOLE_SSL : 0),
        ...
        'options' => [
            ...
            'send_yield' => true,
            // You must add --enable-openssl while compiling Swoole
            'ssl_cert_file' => storage_path("app/cert/" . env('APP_URL') . ".crt"),
            'ssl_key_file' => storage_path("app/cert/" . env('APP_URL') . ".key"),
        ],
    ],
